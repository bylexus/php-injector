...
class TimestampConditionTest extends TestCase
{

    public function test_Construct()
    {
        $i = new \PhpInjector\TimestampCondition(' 1.1.2000..2014/01/01');
        $this->assertInstanceOf(\PhpInjector\TimestampCondition::class, $i);
        $i = new \PhpInjector\TimestampCondition(' >= 20140101');
        $this->assertInstanceOf(\PhpInjector\TimestampCondition::class, $i);
    }
