...
namespace PhpInjector {
    abstract class Condition {
         ...
         * @param array|null $additionalCompareFunctions add your own compare function.
         *    @see StringCondition for an example / layout of the array.
         * @return Condition The specific Condition instance
         */
        public static function getCondition($type, $conditionString, array|null $additionalCompareFunctions = null) {
        ...
        public function __construct($conditionString, array|null $additionalCompareFunctions = null) {
